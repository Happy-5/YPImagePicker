...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    private func setupTrimmerView() {
        ...
        leftLayoutConstraint = trimView.leftAnchor.constraint(equalTo: leftAnchor)
        rightLayoutConstraint = trimView.rightAnchor.constraint(equalTo: rightAnchor)
        leftLayoutConstraint?.isActive = true
        rightLayoutConstraint?.isActive = true
    }
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if isLeftGesture {
                currentLeftConstraint = leftLayoutConstraint!.constant
            } else {
                currentRightConstraint = rightLayoutConstraint!.constant
            }
    ...
    private func updateLeftConstraint(with translation: CGPoint) {
        ...
        leftLayoutConstraint?.constant = newConstraint
    }
    ...
    private func updateRightConstraint(with translation: CGPoint) {
        ...
        rightLayoutConstraint?.constant = newConstraint
    }
    ...
    private func resetHandleViewPosition() {
        ...
        rightLayoutConstraint?.constant = 0
        layoutIfNeeded()
    }
