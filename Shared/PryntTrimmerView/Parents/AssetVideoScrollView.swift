...
class AssetVideoScrollView: UIScrollView {
    ...
    private func setupSubviews() {
        ...
        widthLayoutConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        widthLayoutConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        widthConstraint?.isActive = true
        layoutIfNeeded()
